import{aj as o,aJ as J,ae as Z,aL as j,a3 as k,ah as T,a8 as N,aB as B,a9 as M}from"./iframe-CJeV72rj.js";function D(l,h={}){const{gap:v=0,minVisibleItems:r=0,collapseFrom:p="end",behavior:y="observeSelf"}=h,m=y==="observeParent",[w,x]=o.useState(l),g=o.useRef(null),I=o.useRef(null),i=o.useRef(null),n=o.useCallback(()=>{const e=g.current,s=I.current;if(!e||!s)return;let c;if(m&&e.parentElement){const a=e.parentElement,R=getComputedStyle(a);c=a.clientWidth-parseFloat(R.paddingLeft)-parseFloat(R.paddingRight)}else c=e.offsetWidth;const t=Array.from(s.children),d=t.length>l,u=d?t.slice(0,l):t,b=d?t[t.length-1].offsetWidth:0;if(u.length===0){x(0);return}const f=u.map(a=>a.offsetWidth);let $=0,O=0;const S=p==="end"?f:[...f].reverse();for(let a=0;a<S.length;a++){const R=S[a],z=a>0?v:0,q=$+R+z,A=a===S.length-1?0:b+(O>0||b>0?v:0);if(q+A>c&&O>=r)break;$=q,O++}x(Math.max(Math.min(O,l),r))},[l,v,r,p,m]),P=o.useCallback(e=>{if(g.current=e,i.current&&(J(i.current),i.current=null),e){const s=m&&e.parentElement?e.parentElement:e;Z(s,()=>{n()}),i.current=s}},[n,m]),V=o.useCallback(e=>{I.current=e,e&&n()},[n]);j(()=>{n()},[n]);const C=w<l;return{containerRef:P,measureRef:V,visibleCount:w,hasOverflow:C}}const E={container:{k1xSpc:"astryx78zum5",kGNEyG:"astryx6s0dn4",kVQacm:"astryxb3r6kr",khDVqt:"astryxuxw1ft",k7Eaqz:"astryxeuugli",$$css:!0},fillParent:{kzqmXN:"astryxh8yej3",$$css:!0},measureContainer:{kVAEAm:"astryx10l6tqk",k33iCy:"astryxlshs6z",kZKoxP:"astryxqtp20y",kVQacm:"astryxb3r6kr",k1xSpc:"astryx78zum5",kGNEyG:"astryx6s0dn4",khDVqt:"astryxuxw1ft",kfzvcC:"astryx47corl",$$css:!0}},L={0:{kOIVth:"astryxsn7fz1",khm7nJ:null,k1C7PZ:null,$$css:!0},1:{kOIVth:"astryxzye2dw",khm7nJ:null,k1C7PZ:null,$$css:!0},2:{kOIVth:"astryx1txdalj",khm7nJ:null,k1C7PZ:null,$$css:!0},3:{kOIVth:"astryxjcht0a",khm7nJ:null,k1C7PZ:null,$$css:!0},4:{kOIVth:"astryx18g69wz",khm7nJ:null,k1C7PZ:null,$$css:!0},5:{kOIVth:"astryx9mgr7n",khm7nJ:null,k1C7PZ:null,$$css:!0},6:{kOIVth:"astryx1qh66ti",khm7nJ:null,k1C7PZ:null,$$css:!0},8:{kOIVth:"astryx4t41sb",khm7nJ:null,k1C7PZ:null,$$css:!0},10:{kOIVth:"astryx3hoi3v",khm7nJ:null,k1C7PZ:null,$$css:!0},"0.5":{kOIVth:"astryx1lsbc85",khm7nJ:null,k1C7PZ:null,$$css:!0},"1.5":{kOIVth:"astryx1s4dlld",khm7nJ:null,k1C7PZ:null,$$css:!0}},G={0:0,.5:2,1:4,1.5:6,2:8,3:12,4:16,5:20,6:24,8:32,10:40};function W({children:l,gap:h=2,minVisibleItems:v=0,collapseFrom:r="end",behavior:p="observeSelf",overflowRenderer:y,xstyle:m,className:w,style:x,ref:g,...I}){const i=o.Children.toArray(l),n=i.length,P=G[h],V=p==="observeParent",{containerRef:C,measureRef:e,visibleCount:s,hasOverflow:c}=D(n,{gap:P,minVisibleItems:v,collapseFrom:r,behavior:p}),t=i.map((f,$)=>({child:f,index:$}));let d,u;r==="end"?(d=t.slice(0,s),u=t.slice(s)):(d=t.slice(n-s),u=t.slice(0,n-s));const b=y?.(t);return k.jsxs(k.Fragment,{children:[k.jsxs("div",{ref:e,"aria-hidden":"true",inert:!0,...T(E.measureContainer,L[h]),children:[i,b!=null&&k.jsx("div",{className:"astryx3nfvp2",children:b})]}),k.jsxs("div",{ref:M(g,C),...N(B("overflow-list"),T(E.container,L[h],V&&c&&E.fillParent,m),w,x),...I,children:[r==="start"&&c&&y?.(u),d.map(({child:f})=>f),r==="end"&&c&&y?.(u)]})]})}W.displayName="OverflowList";W.__docgenInfo={description:`A horizontal list that hides items that don't fit and shows an overflow indicator.
