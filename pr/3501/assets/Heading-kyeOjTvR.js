...
import{_ as M}from"./preload-helper-Ct5FWWRu.js";import{aS as P,aj as s,a3 as n,a8 as V,ah as v,aB as D,a9 as W,D as z,w as B,a4 as A,aA as C,aT as N,aD as f,K as U,G as F,aq as I,ap as O,y as $,aE as G}from"./iframe-CJeV72rj.js";const K=s.lazy(async()=>M(()=>import("./iframe-CJeV72rj.js").then(a=>a.j),__vite__mapDeps([0,1,2]),import.meta.url).then(a=>({default:a.Tooltip}))),X={1:"h1",2:"h2",3:"h3",4:"h4",5:"h5",6:"h6"};function y({level:a,type:l,accessibilityLevel:i,color:o="primary",display:h="block",maxLines:e=0,hasTruncateTooltip:r=!0,wordBreak:g,textWrap:d,justify:u="start",hasCapsize:m=!1,hasStrikethrough:b=!1,xstyle:T,className:H,style:w,children:k,ref:S,...x}){const R=X[a],q=i&&i!==a?{"aria-level":i}:{},L=g??(e===1?"break-all":"break-word"),j=e>0||m?"block":h,t=P({maxLines:e}),_=typeof r=="string"?r:"above",c=e>0&&r!==!1&&t.isTruncated,p=s.useRef(null),E=e>1?{WebkitLineClamp:e}:void 0;return n.jsxs(n.Fragment,{children:[n.jsx(R,{ref:W(S,t.ref,p),...V(D("heading",{level:a,color:o,...l&&{type:l}}),v($[o],l?I[l]:O[a],l&&F[l],e===1?f.singleLine:e>1?f.multiLine:U[j],e>0&&N[L],d&&C[d],u!=="start"&&A[u],m&&B.enabled,b&&z.strikethrough,T),H,{...w,...E}),title:c?t.fullText:void 0,...q,...x,children:k}),c&&n.jsx(s.Suspense,{fallback:null,children:n.jsx(K,{anchorRef:p,content:n.jsx("span",{...v(G.content),children:t.fullText}),placement:_})})]})}y.displayName="Heading";y.__docgenInfo={description:`Heading - Semantic heading component
