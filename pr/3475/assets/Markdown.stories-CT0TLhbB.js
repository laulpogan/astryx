import{a1 as e,T as b,ah as i,B as E}from"./iframe-Cw8JXX6x.js";import{M as s}from"./Markdown-M3XPVGxh.js";import{L as w}from"./Link-_RnBZX_s.js";import"./preload-helper-Ct5FWWRu.js";import"./CodeBlock-RIpx8Lgg.js";import"./highlightRanges-DOIM2Tp5.js";import"./CheckboxListItem-BxTPGcvF.js";import"./Field-DzUQIr9Z.js";import"./FieldStatus-C1k4mIkj.js";import"./List-B_76dGfD.js";import"./ListItem-BGUteHmb.js";import"./Item-CXatCzfh.js";import"./computeTargetAndRel-BlG0ENK0.js";import"./CheckboxInput-7ijgnJ1p.js";import"./Blockquote-BBkiC-hG.js";import"./Table-Beogfujq.js";import"./ContextMenu-Cje6WKDr.js";import"./renderDropdownItems-Dejv9C11.js";import"./Divider-CXkzIgPQ.js";import"./useListFocus-D1vlaBt6.js";import"./useTypeahead-B3b6_BOq.js";import"./EmptyState-DYORGikM.js";import"./useStreamingText-D-n1qWiM.js";import"./Citation-BGom681Z.js";import"./Code-BtKazpm5.js";import"./useInteractiveRole-GZ6CKFNP.js";const ae={title:"Core/Markdown",component:s,tags:["autodocs"],argTypes:{density:{control:"select",options:["default","compact"]},headingLevelStart:{control:"select",options:[1,2,3,4,5,6]},isStreaming:{control:"boolean"},display:{control:"select",options:["block","inline"]}}},f=["# Markdown Demo","","Renders **markdown** with *design-system-consistent* styling.","","## Features","","- Headings mapped to Astryx type scale","- **Bold**, *italic*, and ~~strikethrough~~ text","- [Links](https://example.com) with external detection","- Inline `code` and fenced code blocks","","### Code Block","","```typescript","interface User {","  id: string;","  name: string;","}","","function greet(user: User) {","  return `Hello, ${user.name}!`;","}","```","","### Blockquote","","> Design systems free teams to focus on problems that matter.","","### Table","","| Component | Status | Tests |","|:----------|:------:|------:|","| Markdown | Active | 73 |","| CodeBlock | Active | 44 |","","### Task List","","- [x] Parser","- [x] Renderer","- [ ] Storybook stories","","---","","1. First ordered item","2. Second ordered item"].join(`
...
}`,...x.parameters?.docs?.source}}};const re=["Default","Compact","AIResponse","ShiftedHeadings","InlineDisplay","TableFocused","Streaming","WithImages","ContentAlignStart","ContentAlignCenter","InlinePlugins"];export{c as AIResponse,d as Compact,y as ContentAlignCenter,u as ContentAlignStart,o as Default,p as InlineDisplay,x as InlinePlugins,l as ShiftedHeadings,h as Streaming,m as TableFocused,g as WithImages,re as __namedExportsOrder,ae as default};
