...
}`,...y.parameters?.docs?.source},description:{story:"All variant × position × align combinations in one scrollable view.\nOne row per combination, labelled clearly. The `none` values are omitted.",...y.parameters?.docs?.description}}};const xe=["Default","ServerSide","PageSizeSelector","CursorBased","PositionAbove","PositionBoth","WithSelection","Playground","OptionsMatrix"];export{z as CursorBased,P as Default,y as OptionsMatrix,x as PageSizeSelector,v as Playground,f as PositionAbove,j as PositionBoth,b as ServerSide,T as WithSelection,xe as __namedExportsOrder,be as default};
