import{ah as s,a1 as d,a6 as P,ay as j}from"./iframe-peXjO1yC.js";import{F as H}from"./Field-BF1CRCyJ.js";import{L as _}from"./List-B3X1uraz.js";import{C as F}from"./CheckboxInput-BgPjBqAd.js";import{L as z,a as B}from"./ListItem-DbeTiFzz.js";const T=s.createContext(null);T.displayName="CheckboxListContext";const U=[];function M({label:c,isLabelHidden:t=!1,description:m,status:n,value:f,onChange:b,changeAction:a,density:y="balanced",hasDividers:x=!1,isDisabled:u=!1,isReadOnly:g=!1,children:k,ref:C,width:e,xstyle:q,className:R,style:L,"data-testid":o}){const l=s.useId(),r=s.useId(),i=s.useId(),v=s.useId(),[,p]=s.useTransition(),h=f!==void 0,w=f??U,[D,S]=s.useOptimistic(w),[V,E]=s.useOptimistic(null),N=s.useCallback((I,A)=>{b?.(I),a&&p(async()=>{S(I),A!==void 0&&E(A),await a(I)})},[b,a,p,S,E]),O=s.useMemo(()=>({value:h?D:void 0,onChange:h?N:void 0,isDisabled:u,isReadOnly:g,loadingValue:V}),[h,D,N,u,g,V]);return d.jsx(H,{ref:C,"data-testid":o,label:c,isLabelHidden:t,description:m,inputID:l,labelID:r,isGroupLabel:!0,descriptionID:m?i:void 0,isDisabled:u,status:n?{type:n.type,message:n.message,messageID:n.message?v:void 0}:void 0,statusVariant:"detached",width:e,xstyle:q,...P(j("checkbox-list"),{className:R,style:L}),children:d.jsx(T,{value:O,children:d.jsx("div",{role:"group","aria-labelledby":r,"aria-describedby":[m?i:null,n?.message?v:null].filter(Boolean).join(" ")||void 0,children:d.jsx(_,{density:y,hasDividers:x,children:k})})})})}M.displayName="CheckboxList";M.__docgenInfo={description:`A checkbox group component for multi-value selection.
...
@default false`,defaultValue:{value:"false",computed:!1}},width:{required:!1,tsType:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},description:"Width of the field. Numbers are treated as pixels, strings are used as-is\n(e.g. `'100%'`). Sizes the whole field (label, control, and status) so they\nstay aligned, unlike setting width via `xstyle`/`className`/`style`."},children:{required:!0,tsType:{name:"ReactNode"},description:"Checkbox list items to render."}},composes:["Omit"]};const X={selected:{kWkggS:"astryxgcxg3y",$$css:!0}};function W({label:c,value:t,description:m,endContent:n,isDisabled:f=!1,isLoading:b=!1,isChecked:a,onCheck:y,ref:x,xstyle:u,className:g,style:k,...C}){const e=s.use(T);if(e&&e.value!==void 0&&t===void 0)throw new Error("CheckboxListItem requires a `value` prop when used inside CheckboxList with a value array.");const L=(s.use(z)?.density??"balanced")==="compact"?"sm":"md",o=(e?.isDisabled??!1)||f,l=e?.isReadOnly??!1,r=b||(e?.loadingValue!=null&&t!==void 0?e.loadingValue===t:!1);let i=!1;e&&e.value!==void 0&&t!==void 0?i=e.value.includes(t):a!==void 0&&(i=a);const v=!l&&(e!=null||y!=null),p=()=>{o||l||r||(e&&e.value!==void 0&&t!==void 0?e.value.includes(t)?e.onChange?.(e.value.filter(w=>w!==t),t):e.onChange?.([...e.value,t],t):y?.(i!==!0))};return d.jsx(B,{...C,ref:x,label:c,description:m,endContent:n,isDisabled:o,onClick:v?p:void 0,"aria-checked":i==="indeterminate"?"mixed":i,"aria-busy":r||void 0,xstyle:[i===!0&&!o&&!l&&X.selected,u],className:g,style:k,startContent:d.jsx(F,{label:typeof c=="string"?c:"Checkbox",isLabelHidden:!0,value:i,onChange:()=>p(),isDisabled:o,isReadOnly:l,isLoading:r,size:L})})}W.displayName="CheckboxListItem";W.__docgenInfo={description:`A checkbox item for use within CheckboxList (collection mode)
