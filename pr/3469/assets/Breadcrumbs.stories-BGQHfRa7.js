import{ah as c,a1 as e,a6 as N,af as T,ay as E,aK as G,a7 as q}from"./iframe-DVtWfngO.js";import{F as O}from"./HomeIcon-DxFbNXBr.js";import{F as X}from"./FolderIcon-DwY6YbFu.js";import{F as Y}from"./Cog6ToothIcon-1YhB9L8k.js";import"./preload-helper-Ct5FWWRu.js";const D=c.createContext({variant:"default",separator:"/"});D.displayName="BreadcrumbContext";const K={root:{k1xSpc:"astryx1lliihq",$$css:!0}};function t({children:s,separator:m="/",variant:o="default",xstyle:u,className:d,style:l,label:p="Breadcrumb",ref:h,...x}){const y=c.useMemo(()=>({variant:o,separator:m}),[o,m]);return e.jsx(D,{value:y,children:e.jsx("nav",{ref:h,"aria-label":p,...N(E("breadcrumbs",{variant:o}),T(K.root,u),d,l),...x,children:e.jsx("ol",{className:"astryx78zum5 astryx6s0dn4 astryx1a02dak astryxe8uvvx astryx1ghz6dp astryx1717udv astryxzye2dw",children:s})})})}t.displayName="Breadcrumbs";t.__docgenInfo={description:`A navigation breadcrumb trail. Wraps BreadcrumbItem children in
...
the hierarchy.`,...i.parameters?.docs?.description}}};const te=["Default","TwoLevels","AutoDetectCurrent","CustomSeparator","WithIcons","WithOnClick","DeepHierarchy","SupportingVariant","SupportingWithIcons","CurrentOnMiddleItem"];export{j as AutoDetectCurrent,i as CurrentOnMiddleItem,v as CustomSeparator,S as DeepHierarchy,B as Default,z as SupportingVariant,k as SupportingWithIcons,I as TwoLevels,C as WithIcons,w as WithOnClick,te as __namedExportsOrder,re as default};
