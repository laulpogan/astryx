const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./iframe-DVtWfngO.js","./preload-helper-Ct5FWWRu.js","./iframe-C0je06NJ.css"])))=>i.map(i=>d[i]);
import{_ as M}from"./preload-helper-Ct5FWWRu.js";import{aP as V,ah as s,a1 as n,a6 as E,af as v,ay as W,a7 as z,C as B,v as D,a2 as C,ax as A,aQ as N,aA as f,J as F,F as U,an as I,am as O,x as $,aB as J}from"./iframe-DVtWfngO.js";const Q=s.lazy(async()=>M(()=>import("./iframe-DVtWfngO.js").then(a=>a.j),__vite__mapDeps([0,1,2]),import.meta.url).then(a=>({default:a.Tooltip}))),X={1:"h1",2:"h2",3:"h3",4:"h4",5:"h5",6:"h6"};function y({level:a,type:l,accessibilityLevel:i,color:o="primary",display:h="block",maxLines:e=0,hasTruncateTooltip:r=!0,wordBreak:g,textWrap:d,justify:u="start",hasCapsize:m=!1,hasStrikethrough:b=!1,xstyle:H,className:T,style:w,children:k,ref:S,...x}){const R=X[a],q=i&&i!==a?{"aria-level":i}:{},L=g??(e===1?"break-all":"break-word"),P=e>0||m?"block":h,t=V({maxLines:e}),_=typeof r=="string"?r:"above",c=e>0&&r!==!1&&t.isTruncated,p=s.useRef(null),j=e>1?{WebkitLineClamp:e}:void 0;return n.jsxs(n.Fragment,{children:[n.jsx(R,{ref:z(S,t.ref,p),...E(W("heading",{level:a,color:o,...l&&{type:l}}),v($[o],l?I[l]:O[a],l&&U[l],e===1?f.singleLine:e>1?f.multiLine:F[P],e>0&&N[L],d&&A[d],u!=="start"&&C[u],m&&D.enabled,b&&B.strikethrough,H),T,{...w,...j}),title:c?t.fullText:void 0,...q,...x,children:k}),c&&n.jsx(s.Suspense,{fallback:null,children:n.jsx(Q,{anchorRef:p,content:n.jsx("span",{...v(J.content),children:t.fullText}),placement:_})})]})}y.displayName="Heading";y.__docgenInfo={description:`Heading - Semantic heading component
