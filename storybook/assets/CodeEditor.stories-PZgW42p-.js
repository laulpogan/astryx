import{a3 as e,aj as m}from"./iframe-CJeV72rj.js";import{C as d}from"./CodeEditor-hbkVw4-e.js";import"./preload-helper-Ct5FWWRu.js";import"./highlightRanges-Bl51GkoT.js";const x={title:"Lab/CodeEditor",component:d,tags:["autodocs"],argTypes:{language:{control:"select",options:["typescript","javascript","json","html","css","python","bash","php","hack","yaml","markdown","plaintext"]},size:{control:"select",options:["sm","md"]},hasLineNumbers:{control:"boolean"},isReadOnly:{control:"boolean"}}},g=`function greet(name: string): string {
