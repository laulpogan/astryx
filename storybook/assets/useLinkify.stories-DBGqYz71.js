...
}`,...u.parameters?.docs?.source},description:{story:"Interactive playground: type text and see it linkified in real time",...u.parameters?.docs?.description}}};const F=["URLs","Emails","CustomPatterns","MixedContent","PlainText","BuiltinsDisabled","Interactive"];export{g as BuiltinsDisabled,d as CustomPatterns,h as Emails,u as Interactive,f as MixedContent,x as PlainText,m as URLs,F as __namedExportsOrder,Z as default};
