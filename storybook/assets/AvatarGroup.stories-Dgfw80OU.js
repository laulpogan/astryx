...
}`,...w.parameters?.docs?.source},description:{story:"Many avatars — 10+ items to verify overlap stacking.",...w.parameters?.docs?.description}}};const Z=["Default","WithOverflow","ClickableOverflow","ServerSideCount","WithStatusDots","AllSizes","InitialsFallback","SingleAvatar","LargeOverflowCount","ZeroOverflow","NarrowContainer","ManyAvatars"];export{h as AllSizes,v as ClickableOverflow,u as Default,A as InitialsFallback,g as LargeOverflowCount,w as ManyAvatars,S as NarrowContainer,y as ServerSideCount,f as SingleAvatar,d as WithOverflow,x as WithStatusDots,k as ZeroOverflow,Z as __namedExportsOrder,J as default};
