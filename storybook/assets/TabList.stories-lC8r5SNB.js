...
}`,...h.parameters?.docs?.source},description:{story:"Overflow with divider — typical page header in a narrow viewport.",...h.parameters?.docs?.description}}};const ce=["Default","WithMenu","MenuWithSelectedChild","SizeVariants","WithIcons","IconOnly","WithActions","FillLayout","Overflow","OverflowWithDivider"];export{p as Default,T as FillLayout,w as IconOnly,g as MenuWithSelectedChild,v as Overflow,h as OverflowWithDivider,j as SizeVariants,x as WithActions,k as WithIcons,y as WithMenu,ce as __namedExportsOrder,ie as default};
