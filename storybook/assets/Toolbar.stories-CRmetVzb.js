...
}`,...h.parameters?.docs?.source},description:{story:"Toolbar with tab navigation. Size cascades from toolbar to tabs and buttons.",...h.parameters?.docs?.description}}};const ke=["Default","ThreeSlot","StartOnly","EndOnly","Compact","WashVariant","InsideCard","TableToolbar","PageHeader","BulkActions","StackedToolbars","InsideLayout","WithTabNavigation"];export{c as BulkActions,C as Compact,s as Default,x as EndOnly,i as InsideCard,b as InsideLayout,d as PageHeader,m as StackedToolbars,y as StartOnly,l as TableToolbar,n as ThreeSlot,j as WashVariant,h as WithTabNavigation,ke as __namedExportsOrder,Fe as default};
