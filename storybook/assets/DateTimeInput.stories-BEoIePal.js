import{aP as fa,aj as e,a3 as n,I as P,a9 as va,V as Re,e as Sa,ah as ge,a8 as ba,aB as Ta}from"./iframe-CJeV72rj.js";import{F as Da}from"./Field-Dfaov6KF.js";import{a as Pe,b as Le,i as Ae,c as L}from"./inputStyles.stylex-Bpqcd25J.js";import{u as Ia,C as wa}from"./Calendar-DACTRx0W.js";import{u as Ca}from"./usePopover-BvooL_2M.js";import{u as Oa}from"./useInputContainer-nE6YxpQg.js";import{i as ka,k as Va,w as ye,D as ja}from"./plainDate-C-ANv9VG.js";import{p as he}from"./dateParser-XTIqkafj.js";import{f as za,b as Ma,p as xe,i as C,c as Ee,a as qa}from"./timeParser-CAi7zy_b.js";import"./preload-helper-Ct5FWWRu.js";import"./FieldStatus-CStyU6QH.js";import"./useFocusTrap-Cb-uSHjk.js";const fe={row:{k1xSpc:"astryx78zum5",kOIVth:"astryx1txdalj",$$css:!0},dateWrapper:{kUk6DE:"astryx98rzlu",kzQI83:null,kmuXW:null,kCS8Yb:"astryx1r8uery",$$css:!0},timeWrapper:{kUk6DE:"astryx98rzlu",kzQI83:null,kmuXW:null,kCS8Yb:"astryx1r8uery",$$css:!0}},Fe={sm:{kZKoxP:"astryx6k0iem",$$css:!0},md:{kZKoxP:"astryx1ueg155",$$css:!0},lg:{kZKoxP:"astryxssyfek",$$css:!0}};function ve(a){if(!a)return{date:void 0,time:void 0};const t=a.indexOf("T");return t===-1?{date:a,time:void 0}:{date:a.slice(0,t),time:a.slice(t+1)}}function A(a,t){if(!(!a||!t))return`${a}T${t}`}function Wa(a){const t=new Date;return Ee({hour:t.getHours(),minute:t.getMinutes(),second:t.getSeconds()},a)}function l({label:a,isLabelHidden:t=!1,description:r,isOptional:O=!1,isRequired:D=!1,isDisabled:w=!1,value:I,onChange:M,changeAction:k,isLoading:ne=!1,min:q,max:W,dateConstraints:Se,hasSeconds:p=!1,hourFormat:re="12h",timeIncrement:se=1,hasClear:Ne=!1,placeholder:He="Select a date",timePlaceholder:be="Select a time",timeLabel:$e,size:Be,status:o,labelTooltip:Ye,numberOfMonths:Ue=1,width:Ke,xstyle:Xe,className:Ze,style:Qe,ref:Ge,...Je}){const ie=fa(Be,"md"),Te=e.useId(),ea=e.useId(),De=e.useId(),Ie=e.useId(),le=e.useRef(null),we=e.useRef(null),Ce=e.useRef(null),Oe=e.useRef(null),oe=e.useRef(void 0),[,ke]=e.useTransition(),[ue,Ve]=e.useOptimistic(I),V=ne||ue!==I,m=w||V,aa={warning:"warning",error:"error",success:"success"},ta={warning:"warning",error:"error",success:"success"},na=[r?De:null,o?.message?Ie:null].filter(Boolean).join(" ")||void 0,g=e.useMemo(()=>ve(q),[q]),y=e.useMemo(()=>ve(W),[W]),s=e.useMemo(()=>ve(ue),[ue]),je=g.date,ze=y.date,{isDateDisabled:_}=Ia({min:je,max:ze,dateConstraints:Se}),b=e.useMemo(()=>{if(!(!g.date||!g.time||!s.date))return s.date===g.date?g.time:void 0},[g.date,g.time,s.date]),T=e.useMemo(()=>{if(!(!y.date||!y.time||!s.date))return s.date===y.date?y.time:void 0},[y.date,y.time,s.date]),[v,j]=e.useState(null),Me=e.useRef(s.date);s.date!==Me.current&&(Me.current=s.date,s.date!==oe.current&&(oe.current=void 0,v!==null&&j(null)));const ra=v!==null?v:s.date&&/^\d{4}-\d{2}-\d{2}$/.test(s.date)?ka(Va(s.date),ja):"",de=v===null||!v.trim()?!0:he(v)!==null,[f,ce]=e.useState(null),[qe,We]=e.useState(!1),_e=re==="12h"?za:Ma,me=e.useMemo(()=>f!==null?f:s.time?_e(s.time,p):"",[f,s.time,_e,p]),pe=e.useMemo(()=>{if(f===null||!f.trim())return!0;const i=xe(f,p);return i?C(i,b,T):!1},[f,p,b,T]),sa=e.useMemo(()=>qe&&!me?re==="12h"?"e.g., 2:30 PM":"e.g., 14:30":be,[qe,me,re,be]),h=e.useCallback(i=>{V||(M(i),k&&ke(async()=>{Ve(i),await k(i)}))},[V,M,k,ke,Ve]),u=Ca({dialogLabel:"Choose date",closeButtonLabel:"Close calendar",onHide:()=>le.current?.focus()}),ia=e.useCallback(()=>{m||(u.isOpen?u.hide():u.show())},[m,u]),la=e.useCallback(()=>{!m&&!u.isOpen&&u.show({skipAutoFocus:!0})},[m,u]),z=e.useCallback((i,d)=>{let c=s.time??Wa(p);g.date&&i===g.date&&g.time&&(C(c,g.time,void 0)||(c=g.time)),y.date&&i===y.date&&y.time&&(C(c,void 0,y.time)||(c=y.time));const S=A(i,c);S&&h(S),d==="calendar"&&(j(null),u.hide())},[s.time,p,g,y,h,u]),oa=e.useCallback(i=>{const d=i.target.value;j(d);const x=he(d);if(x&&ye(x)!==s.date&&!_(x)){const c=ye(x);oe.current=c,z(c,"input"),Oe.current?.navigateTo(c)}},[s.date,_,z]),R=e.useCallback(()=>{if(v===null)return;if(!v.trim()){I!==void 0&&h(void 0),j(null);return}const i=he(v);if(i&&!_(i)){const d=ye(i);d!==s.date&&z(d,"input")}j(null)},[v,I,s.date,h,_,z]),ua=e.useCallback(()=>{R()},[R]),da=e.useCallback(i=>{i.key==="Escape"&&u.isOpen?(i.preventDefault(),u.hide()):i.key==="Enter"&&(i.preventDefault(),R())},[u,R]),ca=e.useCallback(i=>{const d=i.target.value;ce(d);const x=xe(d,p);if(x&&C(x,b,T)&&x!==s.time&&s.date){const c=A(s.date,x);c&&h(c)}},[p,b,T,s.time,s.date,h]),ma=e.useCallback(()=>We(!0),[]),pa=e.useCallback(()=>{if(We(!1),f===null)return;if(!f.trim()){ce(null);return}const i=xe(f,p);if(i&&C(i,b,T)&&i!==s.time&&s.date){const d=A(s.date,i);d&&h(d)}ce(null)},[f,p,b,T,s,h]),ga=e.useCallback(i=>{if(i.key==="ArrowUp"||i.key==="ArrowDown"){i.preventDefault();let d=s.time;if(!d){const S=new Date;d=Ee({hour:S.getHours(),minute:S.getMinutes(),second:S.getSeconds()},p)}const x=i.key==="ArrowUp"?se:-se,c=qa(d,x,p);if(C(c,b,T)&&s.date){const S=A(s.date,c);S&&h(S)}}},[s,p,se,b,T,h]),ya=e.useCallback(()=>{h(void 0),le.current?.focus()},[h]),{onClick:ha,onMouseUp:xa}=Oa({containerRef:Ce,inputRef:we,disabled:m});return n.jsxs(Da,{label:a,isLabelHidden:t,description:r,inputID:Te,descriptionID:r?De:void 0,isOptional:O,isRequired:D,isDisabled:w,status:o?{type:o.type,message:o.message,messageID:o.message?Ie:void 0}:void 0,labelTooltip:Ye,statusVariant:"detached",width:Ke,children:[n.jsxs("div",{...Je,...ba(Ta("date-time-input",{size:ie,status:o?.type??null}),ge(fe.row,Xe),Ze,Qe),children:[n.jsxs("div",{ref:u.triggerRef,...ge(L.base,Fe[ie],fe.dateWrapper,m&&L.disabled,o&&Ae[o.type],o&&Le[o.type],o&&Pe[o.type]),children:[n.jsx("button",{type:"button",onClick:ia,disabled:m,"aria-label":u.isOpen?"Close calendar":"Open calendar",...{0:{className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryx1ypdohk astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto"},1:{className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto astryx1h6gzvc"}}[!!m<<0],children:n.jsx(P,{icon:"calendar",size:"sm",color:"secondary"})}),n.jsx("input",{ref:va(Ge,le),id:Te,type:"text",role:"combobox",value:ra,onChange:oa,onBlur:ua,onClick:la,onKeyDown:da,placeholder:He,disabled:m,"aria-describedby":na,"aria-required":D===!0?"true":void 0,"aria-invalid":o?.type==="error"||!de?"true":void 0,"aria-busy":V||void 0,"aria-expanded":u.isOpen,"aria-haspopup":"dialog","aria-controls":u.isOpen?u.id:void 0,"aria-autocomplete":"none",autoComplete:"off",...{0:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5"},2:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc"},1:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryxv1l7n4"},3:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc astryxv1l7n4"}}[!!m<<1|!de<<0]}),n.jsx(Re,{as:"div",role:"alert","aria-live":"assertive",children:de?"":"Invalid date"}),Ne&&I!==void 0&&!m&&n.jsx("button",{type:"button",onClick:ya,"aria-label":`Clear ${a}`,className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx1717udv astryx1ghz6dp astryxc342km astryxng3xce astryxjbqb8w astryx1ypdohk astryxh6dtrn astryx1a2a7pz astryx1p25gnr astryx1y3gkto",children:n.jsx(P,{icon:"close",size:"sm",color:"secondary"})}),V&&n.jsx(Sa,{size:"sm"}),o&&n.jsx(P,{icon:aa[o.type],size:"md",color:ta[o.type]})]}),n.jsxs("div",{ref:Ce,onClick:ha,onMouseUp:xa,...ge(L.base,Fe[ie],fe.timeWrapper,m&&L.disabled,o&&Ae[o.type],o&&Le[o.type],o&&Pe[o.type]),children:[n.jsx("div",{className:"astryx78zum5 astryx6s0dn4 astryxl56j7k astryx2lah0s",children:n.jsx(P,{icon:"clock",size:"sm",color:"secondary"})}),n.jsx("input",{ref:we,id:ea,type:"text",value:me,onChange:ca,onFocus:ma,onBlur:pa,onKeyDown:ga,placeholder:sa,disabled:m,"aria-label":$e??`${a} time`,"aria-required":D===!0?"true":void 0,"aria-invalid":o?.type==="error"||!pe?"true":void 0,...{0:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5"},2:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc"},1:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryxv1l7n4"},3:{className:"astryx1lliihq astryx98rzlu astryxeuugli astryxc342km astryxng3xce astryx1717udv astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxjbqb8w astryx1a2a7pz astryxeyghm5 astryx1h6gzvc astryxv1l7n4"}}[!!m<<1|!pe<<0]}),n.jsx(Re,{as:"div",role:"alert","aria-live":"assertive",children:pe?"":"Invalid time"})]})]}),u.render(n.jsx(wa,{handleRef:Oe,mode:"single",value:s.date,onChange:i=>z(i,"calendar"),min:je,max:ze,dateConstraints:Se,numberOfMonths:Ue}),{placement:"below",alignment:"start"})]})}l.displayName="DateTimeInput";l.__docgenInfo={description:`A combined date and time picker with side-by-side date input and
...
}`,...te.parameters?.docs?.source}}};const Ka=["Default","WithValue","TwentyFourHourFormat","WithSeconds","WithDescription","WithClearButton","WithMinMax","WithTimeIncrement","Optional","Required","Disabled","SizeVariants","TwoMonthCalendar","WithErrorStatus","WithWarningStatus","WithSuccessStatus","AllVariations"];export{te as AllVariations,F as Default,Z as Disabled,K as Optional,X as Required,Q as SizeVariants,N as TwentyFourHourFormat,G as TwoMonthCalendar,B as WithClearButton,$ as WithDescription,J as WithErrorStatus,Y as WithMinMax,H as WithSeconds,ae as WithSuccessStatus,U as WithTimeIncrement,E as WithValue,ee as WithWarningStatus,Ka as __namedExportsOrder,Ua as default};
